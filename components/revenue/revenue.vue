<template>
  <div class="w-full flex items-center justify-center mt-7">
    <div class="py-4 sm:py-6 md:py-8 bg-white shadow rounded-lg">
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-6 xl:px-10 gap-y-8 gap-x-12 2xl:gap-x-28"
      >
        <div class="w-full">
          <p
            tabindex="0"
          ...
          <p
            tabindex="0"
            class="focus:outline-none text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold leading-3 text-gray-800 mt-3 md:mt-5"
          >
            89.5%
          </p>
          <div class="flex flex-col md:w-64">
            <div class="w-full flex justify-end">
              <div class="flex items-center">
                <svg
                  tabindex="0"
                  class="focus:outline-none text-green-700"
                  aria-label="up icon"
                  role="img"
                ...
                <p
                  tabindex="0"
                  class="focus:outline-none text-xs leading-none text-green-700"
                >
                  4.3%
                </p>
              </div>
