<template>
  ...
  <div
    class="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-7"
  >
    <div
      class="bg-white dark:bg-gray-800 rounded shadow px-8 py-6 flex items-center"
    >
